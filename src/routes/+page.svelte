...
<div class="min-h-screen font-mono flex flex-col p-8">
  ...
  >
    <div class="grid grid-cols-[auto_1fr] gap-y-2">
      ...
      <div class="text-5xl tracking-tighter text-[#e8dfc7] pr-10">
        <span class="text-[#d5b87c]">❯</span> ./crscutas
      </div>
      ...
      {#if navVisible}
      <nav class="flex flex-col text-5xl tracking-tighter text-[#555] mt-4" out:fade={{ duration: 200 }}>
  ...
  <div class="text-sm text-[#666] flex items-center gap-2 font-light">
    <div class="flex items-center gap-1.5">
      <kbd class="px-2 py-1 bg-[#2a2a2a] border border-[#3a3a3a] rounded text-xs text-[#888]">↑</kbd>
      <kbd class="px-2 py-1 bg-[#2a2a2a] border border-[#3a3a3a] rounded text-xs text-[#888]">↓</kbd>
      <span class="text-[#444]">or</span>
      <kbd class="px-2 py-1 bg-[#2a2a2a] border border-[#3a3a3a] rounded text-xs text-[#888]">Tab</kbd>
    </div>
    <span class="mx-2 text-[#333]">•</span>
    <span>Press <kbd class="px-2 py-1 bg-[#2a2a2a] border border-[#3a3a3a] rounded text-xs text-[#888]">Enter</kbd> to open</span>
  </div>
</div>
